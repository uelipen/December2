...
\begin{figure}
  \centering
   ...
   which is nearly impossible in the Poisson case (grey).  The peak at
 110 events is an artefact of the small scale cutoff in our $1/f$
 process, resulting in a parity symmetry that no events are equally likely to
 all events.}
   \label{FIG-hist}
\end{figure}
